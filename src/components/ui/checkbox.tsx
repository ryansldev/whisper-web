...
export function CheckboxField({ className, ...props }: CheckboxFieldProps) {
  return (
    <>
      ...
      <div className={twMerge("flex items-center justify-center w-6 h-6 border-2 dark:border-neutral-700 dark:bg-neutral-800 rounded-md transition-all duration-200 peer-checked:bg-neutral-600 peer-checked:dark:border-neutral-600 peer-checked:dark:border-1 [&>*:first-child]:opacity-0 peer-checked:[&>*:first-child]:opacity-100", className)}>
