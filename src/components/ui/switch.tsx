...
export function SwitchLabel({ className, ...props }: SwitchLabelProps) {
  return (
    <label className={twMerge("group flex items-center gap-3 cursor-pointer aria-disabled:pointer-events-none aria-disabled:text-neutral-600 aria-disabled:cursor-not-allowed", className)} {...props} />
  )
}
  ...
  return (
    <>
      ...
      <div className={twMerge(`
        ...
        dark:bg-neutral-800 dark:peer-checked:bg-neutral-600 rounded-full
        p-1 transition-all duration-300 peer-checked:[&>*:first-child]:translate-x-6
        peer-checked:[&>*:first-child]:bg-neutral-50 peer-checked:border-0
        group-aria-disabled:bg-neutral-900
        group-aria-disabled:[&>*:first-child]:bg-neutral-700
